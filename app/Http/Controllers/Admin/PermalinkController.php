...
class PermalinkController extends Controller
{
    public function index()
    {
        ...
        return view('admin.permalinks.index', compact('permalinks'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.permalinks.create');
    }
    ...
    public function store(StorePermalinkRequest $request)
    {
        ...
        return redirect()->route('admin.permalinks.index');
    }
    ...
    public function edit(Permalink $permalink)
    {
        ...
        return view('admin.permalinks.edit', compact('permalink'));
    }
    ...
    public function show(Permalink $permalink)
    {
        ...
        return view('admin.permalinks.show', compact('permalink'));
    }
