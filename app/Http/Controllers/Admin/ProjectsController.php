...
class ProjectsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Project::with(['country', 'state', 'city', 'property_features', 'property_type', 'features', 'facilities', 'investors', 'created_by'])->select(sprintf('%s.*', (new Project())->table));
        ...
        return view('admin.projects.index', compact('countries', 'states', 'cities', 'property_features', 'property_types', 'facilities', 'investors', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.projects.create', compact('countries', 'states', 'cities', 'property_features', 'property_types', 'features', 'facilities', 'investors'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('admin.projects.edit', compact('countries', 'states', 'cities', 'property_features', 'property_types', 'features', 'facilities', 'investors', 'project'));
    }
    ...
    public function show(Project $project)
    {
        ...
        $project->load('country', 'state', 'city', 'property_features', 'property_type', 'features', 'facilities', 'investors', 'created_by', 'projectProperties', 'projectLinkReviews', 'projectLinkSliders');
