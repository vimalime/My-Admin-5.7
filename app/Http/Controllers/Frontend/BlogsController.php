...
class BlogsController extends Controller
{
    ...
    public function index()
    {
        ...
        $blogs = Blog::with(['blog_categories', 'blog_tags', 'template', 'created_by', 'media'])->get();
        ...
        return view('frontend.blogs.index', compact('blogs', 'blog_categories', 'blog_tags', 'templates', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.blogs.create', compact('blog_categories', 'blog_tags', 'templates'));
    }
    ...
    public function edit(Blog $blog)
    {
        ...
        return view('frontend.blogs.edit', compact('blog_categories', 'blog_tags', 'templates', 'blog'));
    }
