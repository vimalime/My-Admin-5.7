                    ...
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ $user->is_featured || old('is_featured', 0) === 1 ? 'checked' : '' }}>
                                <label for="is_featured">{{ trans('cruds.user.fields.is_featured') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="credits" id="credits" value="{{ old('credits', $user->credits) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pin_code" id="pin_code" value="{{ old('pin_code', $user->pin_code) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qualification" id="qualification" value="{{ old('qualification', $user->qualification) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="exprience" id="exprience" value="{{ old('exprience', $user->exprience) }}">
                            @if($errors->has('exprience'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('exprience') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="about_us" id="about_us">{{ old('about_us', $user->about_us) }}</textarea>
