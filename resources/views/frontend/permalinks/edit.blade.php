        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.permalink.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.permalinks.update", [$permalink->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="pages">{{ trans('cruds.permalink.fields.pages') }}</label>
                            <input class="form-control" type="text" name="pages" id="pages" value="{{ old('pages', $permalink->pages) }}">
                            @if($errors->has('pages'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="blog_posts" id="blog_posts" value="{{ old('blog_posts', $permalink->blog_posts) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="blog_categories" id="blog_categories" value="{{ old('blog_categories', $permalink->blog_categories) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="blog_tags" id="blog_tags" value="{{ old('blog_tags', $permalink->blog_tags) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="careers" id="careers" value="{{ old('careers', $permalink->careers) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="real_estate_properties" id="real_estate_properties" value="{{ old('real_estate_properties', $permalink->real_estate_properties) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="real_estate_property_categories" id="real_estate_property_categories" value="{{ old('real_estate_property_categories', $permalink->real_estate_property_categories) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="real_estate_projects" id="real_estate_projects" value="{{ old('real_estate_projects', $permalink->real_estate_projects) }}">
