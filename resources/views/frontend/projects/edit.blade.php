                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $project->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ $project->is_featured || old('is_featured', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_premium" id="is_premium" value="1" {{ $project->is_premium || old('is_premium', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="except" id="except">{{ old('except', $project->except) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $project->content) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="country_id" id="country_id">
                                @foreach($countries as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $project->country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="state_id" id="state_id">
                                @foreach($states as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('state_id') ? old('state_id') : $project->state->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('state'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="city_id" id="city_id">
                                @foreach($cities as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $project->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="property_location" id="property_location" value="{{ old('property_location', $project->property_location) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="latitude" id="latitude" value="{{ old('latitude', $project->latitude) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="longitude" id="longitude" value="{{ old('longitude', $project->longitude) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $project->price) }}" step="0.01">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="period" id="period">
                                ...
                                @foreach(App\Models\Project::PERIOD_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('period', $project->period) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="never_expired" id="never_expired" value="1" {{ $project->never_expired || old('never_expired', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="video_url" id="video_url" value="{{ old('video_url', $project->video_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="property_features_id" id="property_features_id">
                                @foreach($property_features as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('property_features_id') ? old('property_features_id') : $project->property_features->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="property_type_id" id="property_type_id">
                                @foreach($property_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('property_type_id') ? old('property_type_id') : $project->property_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="features[]" id="features" multiple>
                                @foreach($features as $id => $features)
                                    <option value="{{ $id }}" {{ (in_array($id, old('features', [])) || $project->features->contains($id)) ? 'selected' : '' }}>{{ $features }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="facilities[]" id="facilities" multiple>
                                @foreach($facilities as $id => $facilities)
                                    <option value="{{ $id }}" {{ (in_array($id, old('facilities', [])) || $project->facilities->contains($id)) ? 'selected' : '' }}>{{ $facilities }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="distance_between_facilities" id="distance_between_facilities" value="{{ old('distance_between_facilities', $project->distance_between_facilities) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="number_blocks" id="number_blocks" value="{{ old('number_blocks', $project->number_blocks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="number_floors" id="number_floors" value="{{ old('number_floors', $project->number_floors) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="number_flats" id="number_flats" value="{{ old('number_flats', $project->number_flats) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="lowest_price" id="lowest_price" value="{{ old('lowest_price', $project->lowest_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="currency" id="currency">
                                ...
                                @foreach(App\Models\Project::CURRENCY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('currency', $project->currency) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_price" id="max_price" value="{{ old('max_price', $project->max_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_description" id="meta_description">{{ old('meta_description', $project->meta_description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_keywords" id="meta_keywords">{{ old('meta_keywords', $project->meta_keywords) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="investors_id" id="investors_id">
                                @foreach($investors as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('investors_id') ? old('investors_id') : $project->investors->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="finish_date" id="finish_date" value="{{ old('finish_date', $project->finish_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="open_sell_date" id="open_sell_date" value="{{ old('open_sell_date', $project->open_sell_date) }}">
