                    ...
                    <form method="POST" action="{{ route("frontend.products.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <label for="is_premium">{{ trans('cruds.product.fields.is_premium') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="post_date" id="post_date" value="{{ old('post_date') }}">
