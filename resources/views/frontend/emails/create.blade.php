                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.emails.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_driver" id="email_driver" value="{{ old('email_driver', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_mail_gun_domain" id="email_mail_gun_domain" value="{{ old('email_mail_gun_domain', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_mail_gun_endpoint" id="email_mail_gun_endpoint" value="{{ old('email_mail_gun_endpoint', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_from_name" id="email_from_name" value="{{ old('email_from_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_from_address" id="email_from_address" value="{{ old('email_from_address', '') }}">
