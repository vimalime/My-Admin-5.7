            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
                    <li role="presentation">
                        <a href="#property_link_reviews" aria-controls="property_link_reviews" role="tab" data-toggle="tab">
                            {{ trans('cruds.review.title') }}
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#property_link_sliders" aria-controls="property_link_sliders" role="tab" data-toggle="tab">
                            {{ trans('cruds.slider.title') }}
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane" role="tabpanel" id="property_link_reviews">
                        @includeIf('admin.properties.relationships.propertyLinkReviews', ['reviews' => $property->propertyLinkReviews])
                    </div>
                    <div class="tab-pane" role="tabpanel" id="property_link_sliders">
                        @includeIf('admin.properties.relationships.propertyLinkSliders', ['sliders' => $property->propertyLinkSliders])
                    </div>
                </div>
            </div>
