            ...
            <div class="panel panel-default">
                ...
                <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
                    <li role="presentation">
                        <a href="#product_link_reviews" aria-controls="product_link_reviews" role="tab" data-toggle="tab">
                            {{ trans('cruds.review.title') }}
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#product_link_sliders" aria-controls="product_link_sliders" role="tab" data-toggle="tab">
                            {{ trans('cruds.slider.title') }}
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane" role="tabpanel" id="product_link_reviews">
                        @includeIf('admin.products.relationships.productLinkReviews', ['reviews' => $product->productLinkReviews])
                    </div>
                    <div class="tab-pane" role="tabpanel" id="product_link_sliders">
                        @includeIf('admin.products.relationships.productLinkSliders', ['sliders' => $product->productLinkSliders])
                    </div>
                </div>
            </div>
