                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.pages.update", [$page->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('except') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="except" id="except">{{ old('except', $page->except) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('is_featured') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ $page->is_featured || old('is_featured', 0) === 1 ? 'checked' : '' }}>
                                <label for="is_featured" style="font-weight: 400">{{ trans('cruds.page.fields.is_featured') }}</label>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('is_premium') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_premium" id="is_premium" value="1" {{ $page->is_premium || old('is_premium', 0) === 1 ? 'checked' : '' }}>
                                <label for="is_premium" style="font-weight: 400">{{ trans('cruds.page.fields.is_premium') }}</label>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('publish_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="publish_date" id="publish_date" value="{{ old('publish_date', $page->publish_date) }}" required>
