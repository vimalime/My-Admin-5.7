                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.cities.update", [$city->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $city->slug) }}" required>
                            @if($errors->has('slug'))
                        ...
                        <div class="form-group {{ $errors->has('order') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="order" id="order" value="{{ old('order', $city->order) }}" step="1" required>
                            @if($errors->has('order'))
