            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-createdByFaqCategories">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.faqCategory.fields.created_at') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.faqCategory.fields.updated_at') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
...
@endcan
  ...
  let table = $('.datatable-createdByFaqCategories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
