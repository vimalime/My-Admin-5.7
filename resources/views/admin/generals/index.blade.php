        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-General">
                        <thead>
                            <tr>
                                <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.generals.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'admin_email', name: 'admin_email' },
{ data: 'admin_title', name: 'admin_title' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-General').DataTable(dtOverrideGlobals);
